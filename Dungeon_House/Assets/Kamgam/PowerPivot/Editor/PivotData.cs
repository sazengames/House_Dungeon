...
namespace Kamgam.PowerPivot
{
    ...
    {
        [FormerlySerializedAs("PivotDelta")]
        public Vector3 PivotDeltaPos;
        
        public Quaternion PivotDeltaRot;

        public Mesh OriginalMesh;
        public Mesh ModifiedMesh;

        public static PivotData CreateOrUpdate(
            PivotData data, Mesh originalMesh, Mesh newMesh, Vector3 pivotDeltaPos, Quaternion pivotDeltaRot
            )
        {
            if (data == null)
            ...
            data.PivotDeltaPos = pivotDeltaPos;
            data.PivotDeltaRot = pivotDeltaRot;
