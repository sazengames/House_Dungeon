...
namespace Kamgam.PowerPivot
{
    public class PowerPivotSettings : ScriptableObject
    {
        ...
        [SerializeField, Tooltip(_ChangeMeshColliderGeometryTooltip)]
        public bool ChangeMeshColliderGeometry = false;
        public const string _ChangeMeshColliderGeometryTooltip = "If enabled then the mesh collider mesh will be updated. Do NOT enable this if the actual mesh and the collider mesh are the same mesh. Use only for custom collider mehses.";
        ...
        public static PowerPivotSettings GetOrCreateSettings()
        {
            if (cachedSettings == null)
            {
                ...
                if (cachedSettings == null)
                {
                    ...
                    cachedSettings.ChangeMeshColliderGeometry = false;
        ...
        public static SettingsProvider CreatePowerPivotSettingsProvider()
        {
            var provider = new SettingsProvider("Project/Power Pivot", SettingsScope.Project)
            {
                ...
                guiHandler = (searchContext) =>
                {
                    ...
                    drawField(settings, "ChangeMeshColliderGeometry", "Change Mesh Collider Geometry:", PowerPivotSettings._ChangeMeshColliderGeometryTooltip);
                    GUILayout.Space(5);
