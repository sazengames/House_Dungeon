...
namespace Kamgam.PowerPivot
{
    ...
    {
        public static bool IsEmptyGameObject<T>(this IEnumerable<T> source)
        {
        ...
        /// <returns></returns>
        public static Quaternion InverseTransformRotation(this Transform t, Quaternion globalRotation)
        {

            return Quaternion.Inverse(t.rotation) * globalRotation;
        }
        
        /// <summary>
        /// Convert rotation from local space to world space.
        /// </summary>
        /// <param name="t"></param>
