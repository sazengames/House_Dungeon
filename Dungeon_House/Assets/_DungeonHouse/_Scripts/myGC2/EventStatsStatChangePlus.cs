...
{
    [Title("On Stat Change Plus")]
    [Category("Stats/On Stat Change Plus")]
    ...
    [Serializable]
    public class EventStatsStatChangePlus : VisualScripting.Event
    {
        ...
        private void OnChange()
        {
            ...
            if (this.m_When == DetectionType.OnInBetween && nextValue < minValue) 
            { 
                this.m_AlReadyRan = false;
                return; 
            }
            if (this.m_When == DetectionType.OnInBetween && nextValue > maxValue) 
            { 
                this.m_AlReadyRan = false;
                return; 
            }
